...
class ArchiveCodecTests(unittest.TestCase):
    ...
    def test_vendor_pax_policy_accepts_vendor_namespaces_in_both_scopes(self) -> None:
        ...
        policies: tuple[tuple[tar_codec.PaxVendorExtensionPolicy | None, bool], ...] = (
            ...
            (tar_codec.PaxVendorExtensionPolicy.ignore(["Acme"]), True),
            (tar_codec.PaxVendorExtensionPolicy.ignore([keyword]), False),
        )
